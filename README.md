...
### 1. 📂 [포트폴리오](https://github.com/Sminp/portfolio)
> 개인 포트폴리오 웹사이트  
...
### 2. 🧠 [OPTT](https://github.com/kny0716/OPTT)
> 설문조사를 통해 OTT를 추천하는 웹사이트  

- **기간**: 2023.10.26 ~ 2023.12.01 (팀 프로젝트, 팀장)  
- **역할**: 팀장(프로젝트 관리, 백로그 운영), UX/UI 설계 및 프로토타입 제작, Express.js 기반 백엔드 개발  
- **개발환경**:  
  - React, JavaScript, Express.js, Recoil, SCSS  
  - MySQL, AWS EC2 & RDS  
...
### 3. 📊 [Dinary](https://github.com/Sminp/Dinary)
...
- **개발환경**:  
  ...
  - Backend: Java(Spring Boot), MySQL, AWS EC2 & RDS  
...
### 4. 🎮 [UNO Game](https://github.com/Sminp/Softwareengineering.git)
...
### 5. 🍳 [CookIndoor](https://github.com/Seeyou2000/OpenSourceProject)
...
## 📌 Tech Highlights
- **Frontend**: React, Next.js, TypeScript, Zustand, Recoil, Tailwind CSS
- **Backend**: Express.js, MySQL, REST API  
- **Game Dev**: Python, Pygame, OpenCV  
- **Design/UX**: Figma, PowerPoint, 반응형 UI, 프로토타입 제작  
- **Collaboration**: Jira, Confluence, Trello, Notion, GitHub  

---

## 🔍 About Me
- 🌏 교환학생 경험 (오스트리아, 2024) → 글로벌 마인드 & 영어 커뮤니케이션 강화  
- 🎯 목표: **사용자 친화적이고 직관적인 서비스를 만드는 프론트엔드 개발자**  
- 📚 현재: React, Next.js 기반 AI·데이터 시각화 프로젝트 확장 중  
